...
from .ui_utils import (
    load_translations, cleanup_tray_icon, cleanup_on_exit, get_icon_path
)
...
class LlamaTray:
    ...
    def __init__(self):
        """Uygulama başlatıcı"""
        # Merkezi _tray_instance referansını hemen ayarla
        ...
        # QApplication sinyaline cleanup bağla - TEK cleanup kaynağı
        # (atexit kullanılmıyor, sadece aboutToQuit ile temizlik yapılır)
        try:
    ...
    def _init_main_window(self):
        ...
        def window_close_event(event):
            try:
                ...
                # NoneType crash riskini önle: callable kontrolü veya doğrudan delegasyon
